...
const getPays = ()=>{
    ...
    pays.then((data)=>{
        const tableauPays = (0, _lodash.shuffle)(data);
        console.log(tableauPays);
        const currentGame = new (0, _gameDefault.default)(tableauPays);
        ...
        button.addEventListener("click", function(e) {
            ...
            try {
                if (currentGame.gameOver == false) {
                    if (currentGame.currentCountry.checkAnswer(text.value)) currentGame.addPoint;
...
},{"lodash":"3qBDj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Game":"dSAJu"}],"3qBDj":[function(require,module,exports) {
var global = arguments[3];
(function() {
...
class Game {
    ...
    constructor(donnes){
        ...
        this.donnes = donnes;
        this.countryIndex = 0;
        this.currentCountry = new (0, _countryDefault.default)(this.donnes[this.countryIndex]);
    }
    addPoint() {
        this.#score++;
    }
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./Country":"giaLO"}],"giaLO":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Country {
    #donnes;
    ...
    getTranslations() {
        ...
        allTranslations.forEach((element)=>{
            this.translations.push(element.common.toLowerCase());
        });
